...
def graph_model_validate(base_params, model_file, iaca_only):
    ...
    resultfile = './learning/pytorch/results/realtime_results.txt'
...
def main(funct):
    ...
    #                     default=os.path.join(os.curdir, 'learning', 'pytorch', 'inputs', 'embeddings', 'code_delim.emb'))
    ...
    if funct == 'train':
        ...
        raise ValueError('Unknown mode "{}"'.format(funct))
